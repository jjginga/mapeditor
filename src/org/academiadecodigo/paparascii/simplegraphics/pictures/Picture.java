package org.academiadecodigo.paparascii.simplegraphics.pictures;

import org.academiadecodigo.paparascii.simplegraphics.graphics.Canvas;
import org.academiadecodigo.paparascii.simplegraphics.graphics.Color;
import org.academiadecodigo.paparascii.simplegraphics.graphics.Movable;
import org.academiadecodigo.paparascii.simplegraphics.graphics.Shape;
...
public class Picture implements Shape, Movable {
     ...
     */
    public org.academiadecodigo.paparascii.simplegraphics.graphics.Color getColorAt(int i) {
     ...
     */
    public void setColorAt(int i, org.academiadecodigo.paparascii.simplegraphics.graphics.Color color) {
        if (image == null || i < 0 || i >= pixels()) {
            throw new IndexOutOfBoundsException("" + i);
        } else {
     ...
     */
    public org.academiadecodigo.paparascii.simplegraphics.graphics.Color getColorAt(int x, int y) {
        if (image == null || x < 0 || x >= image.getWidth() || y < 0 || y >= image.getHeight()) {
            throw new IndexOutOfBoundsException("(" + x + "," + y + ")");
        } else {
            int rgb = image.getRGB(x, y) & 0xFFFFFF;
            return new org.academiadecodigo.paparascii.simplegraphics.graphics.Color(rgb / 65536, (rgb / 256) % 256, rgb % 256);
        }
    }
    ...
    public void setColorAt(int x, int y, Color color) {
        if (image == null || x < 0 || x >= image.getWidth() || y < 0 || y >= image.getHeight()) {
            ...
            org.academiadecodigo.paparascii.simplegraphics.graphics.Canvas.getInstance().repaint();
        }
    }
     ...
     */
    public void draw() {
        org.academiadecodigo.paparascii.simplegraphics.graphics.Canvas.getInstance().show(this);
    }
     ...
     */
    public void delete() {
        org.academiadecodigo.paparascii.simplegraphics.graphics.Canvas.getInstance().hide(this);
    }
